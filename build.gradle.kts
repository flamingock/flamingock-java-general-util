...
group = "io.flamingock"
val declaredVersion = "1.5.2-SNAPSHOT"
    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                issueManagement {
                    system.set("GitHub")
                    url.set("https://github.com/flamingock/flamingock-java-general-util/issues")
                }
                ...
                scm {
                    connection.set("scm:git:git://github.com/flamingock/flamingock-java-general-util.git")
                    developerConnection.set("scm:git:ssh://github.com/flamingock/flamingock-java-general-util.git")
                    url.set("https://github.com/flamingock/flamingock-java-general-util")
                }
            }
        }
    }
